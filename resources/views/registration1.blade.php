...
<body class="register @if(isset($step) && $step != 1) modal-open @endif">
...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-md-12">
			...
			<div class="modal fade @if(isset($step) && $step != 1) show @endif" id="registerModal2" tabindex="-1" role="dialog" aria-labelledby="registerModalLabel2" @if(isset($step) && $step != 1) style="display:block" @endif aria-hidden="true">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-body">
				        <div class="nav nav-tabs" id="nav-tab" role="tablist">
				          <a class="nav-item nav-link @if($step == 1) active @endif" href="#nav-step1"  @if($step == 1) id="nav-step1-tab" data-toggle="tab" role="tab" aria-controls="nav-step1" aria-selected="true" @else style="cursor:not-allowed" aria-selected="false" @endif >1 Step</a>

				          <a class="nav-item nav-link @if($step == 2) active @endif" href="#nav-step2"  @if($step == 31) id="nav-step2-tab" data-toggle="tab" role="tab" aria-controls="nav-step2" aria-selected="true" @else style="cursor:not-allowed" aria-selected="false" @endif>2 Step</a>

				          <a class="nav-item nav-link @if($step == 3) active @endif" href="#nav-step3"  @if($step == 3) id="nav-step3-tab" data-toggle="tab" role="tab" aria-controls="nav-step3" aria-selected="true" @else style="cursor:not-allowed" aria-selected="false" @endif>3 Step</a>

				          <a class="nav-item nav-link @if($step == 4) active @endif" href="#nav-step4"  @if($step == 4) id="nav-step4-tab" data-toggle="tab" role="tab" aria-controls="nav-step4" aria-selected="true" @else style="cursor:not-allowed" aria-selected="false" @endif>4 Step</a>

				        </div>
				        <div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade @if($step == 1) show active @endif" id="nav-step1" role="tabpanel" aria-labelledby="nav-step1-tab">
								<div class="row">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="first_name" id="first_name" value="@if(isset($user)) $user->first_name @endif">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="second_name">Second Name</label>
													<input type="text" class="form-control" name="last_name" id="last_name" value="@if(isset($user)) $user->last_name @endif">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="email" name="email" value="@if(isset($user)) $user->email @endif">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="password" class="form-control" name="password" id="password" value="@if(isset($user)) $user->password @endif">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label for="password_confirm_coach">Re-confirm password</label>
													<input type="password" class="form-control" name="password_confirm" id="password_confirm" value="@if(isset($user)) $user->password @endif">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="birthday" placeholder="DD/MM/YYYY" id="birthday" value="@if(isset($user)) $user->birthday @endif">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="tel" class="form-control" name="phone" id="phone" value="@if(isset($user)) $user->phone_number @endif">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="tab-pane fade @if($step == 2) show active @endif" id="nav-step2" role="tabpanel" aria-labelledby="nav-step2-tab">
								<div class="row">
									<div class="col-md-8 left">
										<div class="row">
											<div class="col-12">
									...
									<div class="col-md-4 register coach">
										...
										<input type="hidden" name="step" value="@if(isset($step)) {{ $step }} @endif">
										<input type="hidden" name="user_id" value="@if(isset($user)) {{ $user->id }} @endif">
										@csrf
										<button type="submit" class="button">Next</button>
										</form>
							...
							<div class="tab-pane fade @if($step == 3) show active @endif" id="nav-step3" role="tabpanel" aria-labelledby="nav-step3-tab">
								<div class="row">
								<form action="{{ url('saveBankDetail') }}" method="POST">
									<input type="hidden" name="step" value="@if(isset($step)) {{ $step }} @endif">
									<input type="hidden" name="user_id" value="@if(isset($user)) {{ $user->id }} @endif">
									@csrf
									<div class="col-md-8 left">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="dropdown">
														...
														<div class="dropdown-item">
															<input class="radio" id="mastercard" type="radio" name="radio" value="mastercard" >
														...
														<div class="dropdown-divider"></div>
														<div class="dropdown-item">
															<input class="radio" id="visa" type="radio" name="radio" value="visa" >
															<label for="visa">
																Visa
															</label>
														</div>
							...
							<div class="tab-pane fade @if($step == 4) show active @endif" id="nav-step4" role="tabpanel" aria-labelledby="nav-step4-tab">
								<div class="row">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="dropdown-menu" aria-labelledby="dropdownMenu">
														<div class="dropdown-item">
															<input class="radio" id="radio" type="radio" name="interested" value="Bodybilding">
															<label for="radio">
																Bodybilding
															</label>
														</div>
														<div class="dropdown-divider"></div>
														<div class="dropdown-item">
															<input class="radio" id="radio-2" type="radio" name="interested" value="Aerobic">
															<label for="radio-2">
																Aerobic
															</label>
														</div>
														<div class="dropdown-divider"></div>
														<div class="dropdown-item">
															<input class="radio" id="radio-3" type="radio" name="interested"  value="Yoga">
															<label for="radio-3">
																Yoga
															</label>
														</div>
														<div class="dropdown-divider"></div>
														<div class="dropdown-item">
															<input class="radio" id="radio-4" type="radio" name="interested" value="Flexibility">
															<label for="radio-4">
																Flexibility
															</label>
														</div>
														<div class="dropdown-divider"></div>
														<div class="dropdown-item">
															<input class="radio" id="radio-5" type="radio" name="interested" value="All">
															<label for="radio-5">
																All
															</label>
														</div>
