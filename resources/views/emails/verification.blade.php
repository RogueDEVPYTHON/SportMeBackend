    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <h3 style="font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-size: 20px; line-height: 1.2em; color: #111111; font-weight: bold; margin: 0 0 10px; padding: 0;">Hello {{ $username }}</h3>
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0; display: inline-block; max-width: 100%; word-wrap: break-word;">Click the button below to verify your email address.</p>
                <!-- button -->
                ...
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0; display: inline-block; max-width: 100%; word-wrap: break-word;">
                    Button not working? Paste the following link into your browser: <br><a href="{{ url('verify/'.$tmp_token) }}">{{ url('verify/'.$tmp_token) }}</a>.
                	<br><br>You’re receiving this email because you recently created a new Sportmedash.teamalfy.com account or added a new email address. If this wasn’t you, please ignore this email.
                	<br><br>Kind Regards,<br>The Sportmedash.teamalfy.com Team
				</p>
            </td>
        </tr>
    </table>
